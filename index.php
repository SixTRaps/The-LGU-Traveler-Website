...
<html>
	...
	<title>CSC3170 - Traveler Project</title>
  ...
  <!-- Facebook and Twitter integration -->
					...
					<div class="search-wrap">
						<div class="container">
							<ul class="nav nav-tabs">
								<li class="active"><a data-toggle="tab" href="#flight"><i class="flaticon-plane"></i> 航班</a></li>
								<li><a data-toggle="tab" href="#hotel"><i class="flaticon-resort"></i> 酒店</a></li>
								<li><a data-toggle="tab" href="#car"><i class="flaticon-car"></i> 餐厅</a></li>
								
							</ul>
						</div>
						<div class="tab-content">
							<div id="flight" class="tab-pane fade in active">
								<form method="post" class="colorlib-form" action="flight.php">
				              	<div class="row">
				              	 <div class="col-md-3">
				              	 	<div class="form-group">
				                    <label for="date">地点</label>
				                    <div class="form-field">
				                      <input name="cityName" type="text" id="location" class="form-control" placeholder="查找地点" required pattern="北京|上海|广州|西安|南京|杭州|成都|重庆|哈尔滨|三亚">
				                    </div>
				                  </div>
				              	 </div>
				                <div class="col-md-4">
				                  <div class="form-group">
				                    ...
				                    <div class="form-field">
				                      ...
				                      <input type="text" id="date" class="form-control date" placeholder="起飞日期">
				                    </div>
				                  </div>
				                </div>
				                <div class="col-md-3">
				                ...
				                <div class="col-md-2">
									<a href="flight.php">
										<input type="submit"  id="submit" value="搜索航班" class="btn btn-primary btn-block" >
									</a>
				                </div>
				              </div>
				            </form>
				         ...
				         <div id="hotel" class="tab-pane fade">
						      <form method="post" class="colorlib-form" action="hotel.php">
								...
								<div class="col-md-3">
				                  <div class="form-group">
				                    <label for="date">地点</label>
				                    <div class="form-field">
				                      <input name="cityName" type="text" value="" class="form-control" placeholder="查找地点" required pattern="北京|上海|广州|西安|南京|杭州|成都|重庆|哈尔滨|三亚">
				                    </div>
				                  </div>
				                </div>
				                <div class="col-md-2">
				                  <div class="form-group">
				                    <label for="date">入住</label>
				                    <div class="form-field">
				                      <i class="icon icon-calendar2"></i>
				                ...
				                <div class="col-md-2">
									<a href="hotel.php">
										<input type="submit"  id="submit" value="搜索酒店" class="btn btn-primary btn-block" >
									</a>
				                </div>
				              </div>
				            </form>
						   ...
						   <div id="car" class="tab-pane fade">
						   	<form method="post" class="colorlib-form" action="restaurant.php">
				              	<div class="row">
								  <div class="col-md-3">
				              	 	<div class="booknow">
				              	 		<h2>立即预定</h2>
				              	 ...
				              	 <div class="col-md-3">
				                    ...
				                    <label for="date">地点</label>
				                    <div class="form-field">
				                      <input name="cityName" type="text" id="location" class="form-control" placeholder="地点" required pattern="北京|上海|广州|西安|南京|杭州|成都|重庆|哈尔滨|三亚">
				                    </div>
				                  </div>
				              	 </div>
								   <div class="col-md-3">
				                ...
				                <div class="col-md-2">
								  <a href="restaurant.php">
				                    <input type="submit" name="submit" id="submit" value="查询餐厅" class="btn btn-primary btn-block">
								  </a>
				                </div>
				              </div>
				            </form>
	...
	$cityNamename = "bdm308395165";

	$password = "CSC3170csc";

	$dbname = "bdm308395165_db";

	$conn = mysqli_connect($hostname,$cityNamename,$password);
...
<div class="colorlib-tour colorlib-light-grey">
			...
			<div class="tour-wrap">
				<a href="scenery.php?cityName=北京" class="tour-entry animate-box">
					<div class="tour-img" style="background-image: url(traveler_images/scenery_images/BJ/5.jpg);">
					</div>
					<span class="desc">
						<h2>北京</h2>
						<span class="city">Beijing</span>
						<span class="city">“五星红旗迎风飘扬”</span>
					</span>
				</a>
				<a href="scenery.php?cityName=上海" class="tour-entry animate-box">
					<div class="tour-img" style="background-image: url(images/img_bg_2.jpg);">
					</div>
					<span class="desc">
						<h2>上海</h2>
						<span class="city">Shanghai</span>
						<span class="city">“时尚之旅”</span>
					</span>
				</a>
				<a href="scenery.php?cityName=西安" class="tour-entry animate-box">
					<div class="tour-img" style="background-image: url(traveler_images/scenery_images/XA/2.jpg);">
					</div>
					<span class="desc">
						<h2>西安</h2>
						<span class="city">Xi'an</span>
						<span class="city">“十三朝古都”</span>
					</span>
				</a>
				<a href="scenery.php?cityName=广州" class="tour-entry animate-box">
					<div class="tour-img" style="background-image: url(traveler_images/scenery_images/GZ/1.jpg);">
					</div>
					<span class="desc">
						<h2>广州</h2>
						<span class="city">Guangzhou</span>
						<span class="city">“五羊之城”</span>
					</span>
				</a>
				<a href="scenery.php?cityName=哈尔滨" class="tour-entry animate-box">
					<div class="tour-img" style="background-image: url(traveler_images/scenery_images/HEB/2.jpg);">
					</div>
					<span class="desc">
						<h2>哈尔滨</h2>
						<span class="city">Harbin</span>
						<span class="city">“东方小巴黎”</span>
					</span>
				</a>
				<a href="scenery.php?cityName=成都" class="tour-entry animate-box">
					<div class="tour-img" style="background-image: url(traveler_images/scenery_images/CD/4.jpg);">
					</div>
					<span class="desc">
						<h2>成都</h2>
						<span class="city">Chengdu</span>
						<span class="city">“天府之国”</span>
					</span>
				</a>
				<a href="scenery.php?cityName=三亚" class="tour-entry animate-box">
					<div class="tour-img" style="background-image: url(traveler_images/scenery_images/SY/4.jpg);">
					</div>
					<span class="desc">
						<h2>三亚</h2>
						<span class="city">Sanya</span>
						<span class="city">“东方夏威夷”</span>
					</span>
				</a>
				<a href="scenery.php?cityName=杭州" class="tour-entry animate-box">
					<div class="tour-img" style="background-image: url(traveler_images/scenery_images/HZ/3.jpg);">
					</div>
					<span class="desc">
						<h2>杭州</h2>
						<span class="city">Hangzhou</span>
						<span class="city">“人间天堂”</span>
					</span>
				</a>
			</div>
		</div>
						...
						<div class="owl-carousel2">
							<div class="item">
								<div class="testimony text-center">
									<span class="img-cityName" style="background-image: url(images/person1.jpg);"></span>
									<span class="cityName">Alysha Myers</span>
							...
							<div class="item">
								<div class="testimony text-center">
									<span class="img-cityName" style="background-image: url(images/person2.jpg);"></span>
									<span class="cityName">James Fisher</span>
							...
							<div class="item">
								<div class="testimony text-center">
									<span class="img-cityName" style="background-image: url(images/person3.jpg);"></span>
									<span class="cityName">Jacob Webb</span>
